...
video_src_src_path = '/home/aistudio/work/UCF-101'
video_jpg_save_path = '/home/aistudio/work/UCF-101-jpg'
...
for i in label_name:
    ...
    video_save_path = os.path.join(video_jpg_save_path, i)
    ...
    for each_video in videos:
        ...
        while success:
            ...
            if success:
                ...
                cv2.imwrite(each_video_save_full_path + each_video_name + "_%d.jpg" % frame_count, frame, [cv2.IMWRITE_JPEG_QUALITY,50])

            frame_count += 1
        cap.release()
np.save('ucf101_label_dir.npy', label_dir)
print(label_dir)
